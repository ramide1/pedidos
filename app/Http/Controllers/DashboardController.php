...
class DashboardController extends Controller
{
    public function __invoke()
    {
        ...
        $restauranteIds = $restaurantes->pluck('restaurantes.id');
        $totalPedidos = Pedido::whereIn('restaurante_id', $restauranteIds)->count();
        $totalVentas = Pedido::whereIn('restaurante_id', $restauranteIds)->sum('total');
        $totalProductos = Producto::whereIn('restaurante_id', $restauranteIds)->count();
        $pedidosPorMes = Pedido::whereIn('restaurante_id', $restauranteIds)
